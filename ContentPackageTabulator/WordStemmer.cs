...
* retrieved from: http://tartarus.org/~martin/PorterStemmer/csharp3.txt
* PorterStemmer website indicates "All these encodings of the algorithm can be used free of charge for any purpose."
