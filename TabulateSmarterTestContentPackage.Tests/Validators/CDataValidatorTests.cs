...
namespace TabulateSmarterTestContentPackage.Tests.Validators
{
    ...
    public class CDataValidatorTests
    {
        ...
        public void AllMatchingTermsTaggedShouldReturnTrue()
        {
            ...
            // Act
            var result = CDataValidator.AllMatchingTermsTagged(node, new ItemContext(null, null),
        ...
        public void NestedStartTagShouldReturnFalse()
        {
            ...
            var result = CDataValidator.CDataGlossaryTagsAreNotIllegallyNested(node,
                new ItemContext(null, null), ErrorSeverity.Degraded);
        ...
        public void RetrieveImagesFromCData()
        {
            ...
            // Act
            var result =
                itemCData.Select(x => CDataValidator.IsValid(x, new ItemContext(null, null))).ToList();
        ...
        public void ValidStartEndTagsShouldReturnValidDictionary()
        {
            ...
            // Act
            var result = CDataValidator.CDataGlossaryTagStartAndEndTagsLineUpAppropriately(node, new ItemContext(null, null), ErrorSeverity.Benign);
